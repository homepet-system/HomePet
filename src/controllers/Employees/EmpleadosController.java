...
public class EmpleadosController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        if(arrayList.size() >= 4){
            ButtonsCreator.createBtnMore4(arrayList.size(),arrayList,hBox,vBox,employeeBtn,addBtn,100);
        }else {

            ButtonsCreator.createBtnLess4(arrayList.size(),arrayList,hBox,employeeBtn,addBtn,100);
        }
        ...
        EventHandler<ActionEvent> eh = new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                try{
                    Parent root = FXMLLoader.load(getClass().getResource("../../GUI/Empleados/Empleados-Details.fxml"));
